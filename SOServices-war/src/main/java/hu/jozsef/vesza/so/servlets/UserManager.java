...
public class UserManager extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		if (fetchedUsersExist)
		{
			...
			for (User user : fetchedUsers)
			{
				...
				{
					log.severe("Found user: " + user.getUsername() + " password: " + user.getPassword());
					loggedInUser = user;
				}
			}
			...
			{
				log.severe("Everything OK, should return user: " + loggedInUser.getUsername());
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException
	{
		...
		log.severe("Register username: " + username);
		String password = (String) parsedParams.get("password");
		log.severe("Register password: " + password);
		if (username == null)
		{
			log.severe("Username missing");
			ErrorManager.respondWithError("missingUsername", resp);
		...
		{
			log.severe("Everything OK, should return generated user: " + registeredUser.getUsername() + " password:" + registeredUser.getPassword());
